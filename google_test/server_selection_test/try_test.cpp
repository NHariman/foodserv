...
TEST(ServerSelectionTest, TestConfig1) {
    NginxConfig	test1("../test_config/conf1.conf");
...
TEST(ServerSelectionTest, TestConfig2) {
    NginxConfig	test2("../test_config/conf2.conf");
    {
...
TEST(ServerSelectionTest, TestConfig3) {
    NginxConfig	test3("../test_config/conf3.conf");
...
TEST(ServerSelectionTest, TestConfig4) {
	NginxConfig	test4("../test_config/conf4.conf");
